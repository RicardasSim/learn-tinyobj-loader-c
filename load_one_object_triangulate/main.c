...
int main()
{
    ...
    */
    ...
    /*
     NOTE: 2023.01.06
     length shows the number of faces before triangulation
     with example cube - 6 (length)
     face count after triangulation - 12 (attrib.num_face_num_verts)
    */

    /*
     Let's try to get the object data
    */

    // only one object, so 0
